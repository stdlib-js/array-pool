...
tape( 'the function returns a typed array (dtype=float16)', function test( t ) {
	var arr = typedarraypool( 'float16' );
...
tape( 'the function returns a typed array (dtype=float16, length)', function test( t ) {
	var arr = typedarraypool( 10, 'float16' );
	t.strictEqual( instanceOf( arr, Float16Array ), true, 'returns expected value' );
	t.strictEqual( arr.length, 10, 'returns expected value' );
...
tape( 'attached to the exported function is a method which returns a zero-initialized typed array (dtype=float16)', function test( t ) {
	var arr = typedarraypool.calloc( 'float16' );
	t.strictEqual( instanceOf( arr, Float16Array ), true, 'returns expected value' );
	t.strictEqual( arr.length, 0, 'returns expected value' );
...
tape( 'attached to the exported function is a method which returns a zero-initialized typed array (dtype=float16, length)', function test( t ) {
	var arr;
	var tmp;
	var i;
