...
tape( 'the function returns a function which returns a typed array (dtype=float16)', function test( t ) {
	var typedarraypool;
	var arr;

	typedarraypool = factory();

	arr = typedarraypool( 'float16' );
...
tape( 'the function returns a function which returns a typed array (dtype=float16, length)', function test( t ) {
	var typedarraypool;
	var arr;

	typedarraypool = factory();

	arr = typedarraypool( 10, 'float16' );
	t.strictEqual( instanceOf( arr, Float16Array ), true, 'returns expected value' );
	t.strictEqual( arr.length, 10, 'returns expected value' );
...
tape( 'the function returns a function which returns a typed array (dtype=float16, array)', function test( t ) {
	var typedarraypool;
	var arr;
	var out;
	...
	arr = [];
	out = typedarraypool( arr, 'float16' );
...
tape( 'the function returns a function which returns a typed array (dtype=float16, typed array)', function test( t ) {
	var typedarraypool;
	var arr;
	var out;
	...
	arr = new Uint16Array( [ 1.0, 2.0, 3.0 ] );
	out = typedarraypool( arr, 'float16' );
	t.strictEqual( instanceOf( out, Float16Array ), true, 'returns expected value' );
	t.strictEqual( out.length, 3, 'returns expected value' );
	t.strictEqual( out[ 0 ], arr[ 0 ], 'returns expected value' );
...
tape( 'attached to the returned function is a method which returns a zero-initialized typed array (dtype=float16)', function test( t ) {
	var typedarraypool;
	var arr;

	typedarraypool = factory();

	arr = typedarraypool.calloc( 'float16' );
	t.strictEqual( instanceOf( arr, Float16Array ), true, 'returns expected value' );
	t.strictEqual( arr.length, 0, 'returns expected value' );
...
tape( 'attached to the returned function is a method which returns a zero-initialized typed array (dtype=float16, length)', function test( t ) {
	var typedarraypool;
	var arr;
	var tmp;
	var i;
	...
	tmp = typedarraypool.malloc( 10, 'float16' );
	for ( i = 0; i < tmp.length; i++ ) {
		tmp[ i ] = randu() * 256.0;
	}
	typedarraypool.free( tmp );

	arr = typedarraypool.calloc( 10, 'float16' );
	t.strictEqual( instanceOf( arr, Float16Array ), true, 'returns expected value' );
	t.notEqual( arr, tmp, 'returns a new view' );
	t.strictEqual( arr.buffer, tmp.buffer, 'same array buffer' );
...
tape( 'attached to the returned function is a method for clearing a typed array pool of freed typed array buffers', function test( t ) {
	...
	arrs = [];
	for ( i = 0; i < 10; i++ ) {
		arrs.push( typedarraypool( 10, 'uint8' ) );
		t.strictEqual( typedarraypool.nbytes > 0 && typedarraypool.nbytes < typedarraypool.highWaterMark, true, 'returns expected value' );
	}
