...
```javascript
import typedarraypool from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-pool@v0.3.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-pool@v0.3.1-esm/index.mjs';
```
